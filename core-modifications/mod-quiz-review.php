...
// AccuLearn: link to AI-assisted feedback, injected via JS into the real content area
// since Boost's drawer layout clips anything appended after the page wrapper closes.
if (file_exists($CFG->dirroot . '/local/acculearnfeedback/view.php')) {
    $acculearnurl = new moodle_url('/local/acculearnfeedback/view.php', ['attempt' => $attemptobj->get_attemptid()]);
    $acculearnurl = $acculearnurl->out(false);
    echo '<script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (mainRegion) {
                ...
                link.href = "' . $acculearnurl . '";
                link.className = "btn btn-primary";
                link.textContent = "View your AI-assisted feedback";
